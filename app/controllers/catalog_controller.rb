...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_show_field "access_right_tesim"
    config.add_show_field "license_tesi"
    config.add_show_field "final_published_versions_tesim"
    ...
    config.add_show_field "edition_tesi"
    config.add_show_field "volume_tesi"
    config.add_show_field "issue_tesi"
    config.add_show_field "page_range_start_tesi"
    config.add_show_field "page_range_end_tesi"
    config.add_show_field "place_of_production_tesi"
    config.add_show_field "sponsor_tesi"
    config.add_show_field "grant_agencies_tesim"
    config.add_show_field "grant_information_tesim"
    config.add_show_field "related_datasets_tesim"
    ...
    config.add_show_field "internal_rights_note_tesi"
    config.add_show_field "staff_notes_tesim"
    config.add_show_field "system_of_record_ID_tesi"
    config.add_show_field "emory_content_type_tesi"
    config.add_show_field "holding_repository_tesi"
    config.add_show_field "institution_tesi"
    config.add_show_field "data_classification_tesi"
    config.add_show_field "deduplication_key_tesi"
