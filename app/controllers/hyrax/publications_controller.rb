...
module Hyrax
  ...
  class PublicationsController < ApplicationController
    ...
    # [Hyrax-override-v5.2.0] - L#26 defaults visibility in the form to Public.
    def new
    ...
    ##
    # [Hyrax-override-v5.2.0] - inserts PreservationEvents if Publication is created successfully.
    # @return [#errors]
    ...
    # [Hyrax-override-v5.2.0] - inserts PreservationEvents if Publication is updated successfully.
    ...
    # [Hyrax-override-v5.2.0] - adds our respond_to_ris custom method.
