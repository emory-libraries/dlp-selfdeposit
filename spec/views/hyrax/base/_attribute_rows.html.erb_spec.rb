...
RSpec.describe "hyrax/base/_attribute_rows.html.erb", type: :view do
  ...
  context 'admin user' do
    ...
    it "shows a publication's values" do
      ["904dncjsz6-emory", "05/12/2024", "Article", "Tom Collins, Gin University", "English", "2004", "Simon & Schusters", "Final Publisher PDF", "In Copyright",
       "Creative Commons Attribution-ShareAlike 4.0 International", "1020", "Parent title", "Samvera Connect", "fqefeefe2fed", "dvqegr3gvfw", "Series Title", "1",
       "4", "3", "1", "134", "Boston", "NEA", "Rockfeller", "Granted", "A Dataset", "an abstraction", "A note from the author.", "keywordbooks", "Mathematics",
       "Asian studies", "867-5309", "A note about internal rights.", "Oy, this staff!", "12345abcde", "Text", "Emory University. Library", "Emory University",
