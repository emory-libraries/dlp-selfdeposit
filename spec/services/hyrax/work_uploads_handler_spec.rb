...
RSpec.describe Hyrax::WorkUploadsHandler, valkyrie_adapter: :test_adapter do
  ...
  describe '#attach' do
    ...
    context 'after adding files' do
      ...
      xit 'propagates work permissions to file_sets' do
        service.attach
        expect(work)
    ...
    context 'with existing file_sets' do
      let(:work) { FactoryBot.valkyrie_create(:publication, :public, :with_member_file_sets) }

      xit 'appends the new file sets' do
