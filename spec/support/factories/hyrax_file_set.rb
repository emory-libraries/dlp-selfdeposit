...
# [Hyrax-override-v5.2.0] We have to point the FileSet class to the one we're using.
#
...
FactoryBot.define do
  factory :hyrax_file_set, class: '::FileSet' do
    ...
    trait :with_files do
      transient do
        ios { [File.open(Rails.root + 'spec/fixtures/image.png'), File.open(Rails.root + 'spec/fixtures/Example.ogg')] }
