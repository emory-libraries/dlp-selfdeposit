...
def make_default_collection(col_type)
  col = Collection.new
  col.title = ["OpenEmory"]
  col.creator = ['Emory University']
  col.holding_repository = ['Emory University. Library']
  col.institution = ['Emory University']
  col.description = ['OpenEmory preserves scholarly publications from Emory faculty, graduate, and undergraduate researchers and makes them freely accessible, increasing the visibility of this research and furthering the intellectual community at Emory University.']
  col.collection_type_gid = col_type.to_global_id.to_s
  col.visibility = "open"
